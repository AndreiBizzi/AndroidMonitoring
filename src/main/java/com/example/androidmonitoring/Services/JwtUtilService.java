...
public class JwtUtilService {
    ...
    private String SECRET_KEY = "AndreiBookShop";
    ...
    public Boolean validateToken(String token) {
        ...
        User userFromDB = userService.findUser(idFromJWT);
        System.out.println(userFromDB.getEmail()+userFromDB.getFirstName());
        return (usernameFromJWT != null &&
                userFromDB != null &&
                usernameFromJWT.equals(userFromDB.getUsername()));
    }
    ...
    public String getJwtFromAuthorizationHeader(String authorizationHeader)
    {
        ...
        if(authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            jwt = authorizationHeader.substring(7); //7 = length of "Bearer "
        }
        return jwt;
